...
2. Авторизовываемся и сохраняем API ключ (http://ferma.zhernosek.xyz/Profile.php) 
3. Открывам вкладку "Профили", и нажимаем " + добавить профиль"
4. Указываем обязательные параметры, и создайте все ваши профили ( ваших фермеров );
